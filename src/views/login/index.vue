<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <div>
        <el-button :loading="registerLoading" style="width:100%;margin-bottom:10px; back-ground:white;" @click.native.prevent="handleRegister">注册</el-button>
      </div>
...
<script>
import { login, register } from '../../requests/user'
